...
void kernel4(int array[1024], int index[1024], int offset);
# 2 "kernel4.cpp" 2

void kernel4(int array[1024], int index[1024], int offset)
{_ssdm_SpecArrayDimSize(array, 1024);_ssdm_SpecArrayDimSize(index, 1024);
    int sum = 0;

 loop:for (int i=offset+1; i<1024 -1; ++i)
    {
#pragma HLS PIPELINE
# 8 "kernel4.cpp"
