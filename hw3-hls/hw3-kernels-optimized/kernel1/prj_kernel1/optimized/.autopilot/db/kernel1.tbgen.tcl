...
set ArgLastReadFirstWriteLatency {
	kernel1 {
		array_r {Type IO LastRead 1 FirstWrite 2}}}
...
set Spec2ImplPortList { 
	array_r { ap_memory {  { array_r_address0 mem_address 1 10 }  { array_r_ce0 mem_ce 1 1 }  { array_r_q0 mem_dout 0 32 }  { array_r_address1 MemPortADDR2 1 10 }  { array_r_ce1 MemPortCE2 1 1 }  { array_r_we1 MemPortWE2 1 1 }  { array_r_d1 MemPortDIN2 1 32 } } }
}
