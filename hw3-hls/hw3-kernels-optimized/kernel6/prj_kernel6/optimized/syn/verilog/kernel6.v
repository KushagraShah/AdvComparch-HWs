...
wire   [0:0] icmp_ln8_fu_52_p2;
wire   [31:0] mul_ln8_fu_46_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln8_fu_52_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign icmp_ln8_fu_52_p2 = (($signed(mul_ln8_fu_46_p2) < $signed(x)) ? 1'b1 : 1'b0);

assign mul_ln8_fu_46_p2 = ($signed(i_0_reg_34) * $signed(i_0_reg_34));
