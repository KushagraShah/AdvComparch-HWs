...
architecture behav of kernel2 is 
    ...
    "kernel2,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160t-fbg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.365000,HLS_SYN_LAT=2045,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=3,HLS_SYN_FF=137,HLS_SYN_LUT=265,HLS_VERSION=2019_2}";
    ...
    signal icmp_ln6_reg_157 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln6_reg_157_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_pp0_stage1 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage1 : signal is "none";
    signal ap_block_state3_pp0_stage1_iter0 : BOOLEAN;
    signal ap_block_state5_pp0_stage1_iter1 : BOOLEAN;
    signal ap_block_pp0_stage1_11001 : BOOLEAN;
    signal array_load_1_reg_176 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal array_load_2_reg_181 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_fu_136_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal i_reg_186 : STD_LOGIC_VECTOR (10 downto 0);
    signal add_ln7_3_fu_146_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln7_3_reg_191 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal zext_ln7_3_fu_152_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal mul_ln7_fu_142_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln6_reg_157 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                i_0_reg_85 <= i_reg_186;
            elsif (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln6_reg_157 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                add_ln7_3_reg_191 <= add_ln7_3_fu_146_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (icmp_ln6_reg_157 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                array_load_1_reg_176 <= array_r_q0;
                array_load_2_reg_181 <= array_r_q1;
                i_reg_186 <= i_fu_136_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                icmp_ln6_reg_157 <= icmp_ln6_fu_97_p2;
                icmp_ln6_reg_157_pp0_iter1_reg <= icmp_ln6_reg_157;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, icmp_ln6_fu_97_p2, ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, ap_enable_reg_pp0_iter1, ap_block_pp0_stage1_subdone)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if ((not(((ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (icmp_ln6_fu_97_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage1;
                elsif (((ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (icmp_ln6_fu_97_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then
    ...
    add_ln7_3_fu_146_p2 <= std_logic_vector(unsigned(array_r_q0) + unsigned(mul_ln7_fu_142_p2));
    ...
    ap_enable_operation_17_assign_proc : process(icmp_ln6_fu_97_p2)
    begin
                ap_enable_operation_17 <= (icmp_ln6_fu_97_p2 = ap_const_lv1_0);
    end process;


    ap_enable_operation_21_assign_proc : process(icmp_ln6_fu_97_p2)
    begin
                ap_enable_operation_21 <= (icmp_ln6_fu_97_p2 = ap_const_lv1_0);
    end process;


    ap_enable_operation_25_assign_proc : process(icmp_ln6_reg_157)
    begin
                ap_enable_operation_25 <= (icmp_ln6_reg_157 = ap_const_lv1_0);
    end process;


    ap_enable_operation_26_assign_proc : process(icmp_ln6_reg_157)
    begin
                ap_enable_operation_26 <= (icmp_ln6_reg_157 = ap_const_lv1_0);
    end process;


    ap_enable_operation_27_assign_proc : process(icmp_ln6_reg_157)
    begin
                ap_enable_operation_27 <= (icmp_ln6_reg_157 = ap_const_lv1_0);
    end process;


    ap_enable_operation_29_assign_proc : process(icmp_ln6_reg_157)
    begin
                ap_enable_operation_29 <= (icmp_ln6_reg_157 = ap_const_lv1_0);
    end process;


    ap_enable_operation_37_assign_proc : process(icmp_ln6_reg_157_pp0_iter1_reg)
    begin
                ap_enable_operation_37 <= (icmp_ln6_reg_157_pp0_iter1_reg = ap_const_lv1_0);
    end process;
    ...
    ap_phi_mux_i_0_phi_fu_89_p4_assign_proc : process(i_0_reg_85, ap_CS_fsm_pp0_stage0, icmp_ln6_reg_157, i_reg_186, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0)
    begin
        if (((icmp_ln6_reg_157 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            ap_phi_mux_i_0_phi_fu_89_p4 <= i_reg_186;
        else 
    ...
    array_r_address0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0, zext_ln7_1_fu_109_p1, zext_ln7_fu_131_p1, ap_block_pp0_stage1)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
                array_r_address0 <= zext_ln7_fu_131_p1(10 - 1 downto 0);
    ...
    array_r_address1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, zext_ln7_2_fu_120_p1, ap_block_pp0_stage1, zext_ln7_3_fu_152_p1)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
            array_r_address1 <= zext_ln7_3_fu_152_p1(10 - 1 downto 0);
    ...
    array_r_d1 <= add_ln7_3_reg_191;

    array_r_we1_assign_proc : process(icmp_ln6_reg_157_pp0_iter1_reg, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_11001, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (icmp_ln6_reg_157_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    i_fu_136_p2 <= std_logic_vector(unsigned(i_0_reg_85) + unsigned(ap_const_lv11_1));
    icmp_ln6_fu_97_p2 <= "1" when (ap_phi_mux_i_0_phi_fu_89_p4 = ap_const_lv11_400) else "0";
    mul_ln7_fu_142_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(signed(array_load_1_reg_176) * signed(array_load_2_reg_181))), 32));
    ...
    zext_ln7_3_fu_152_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_0_reg_85_pp0_iter1_reg),64));
