...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("index_address0", 10, hls_out, 1, "ap_memory", "mem_address", 1),
	Port_Property("index_ce0", 1, hls_out, 1, "ap_memory", "mem_ce", 1),
	Port_Property("index_q0", 32, hls_in, 1, "ap_memory", "mem_dout", 1),
	Port_Property("offset", 32, hls_in, 2, "ap_none", "in_data", 1),
};
const char* HLS_Design_Meta::dut_name = "kernel4";
