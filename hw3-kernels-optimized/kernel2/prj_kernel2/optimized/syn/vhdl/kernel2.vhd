...
architecture behav of kernel2 is 
    ...
    signal prev_0_reg_118 : STD_LOGIC_VECTOR (31 downto 0);
    signal reg_128 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal ap_enable_reg_pp0_iter1 : STD_LOGIC := '0';
    signal icmp_ln9_reg_215 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal elem2_reg_194 : STD_LOGIC_VECTOR (31 downto 0);
    signal array_load_1_reg_205 : STD_LOGIC_VECTOR (31 downto 0);
    signal accum_fu_133_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal icmp_ln9_fu_138_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln9_reg_215_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal i_fu_155_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal i_reg_224 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal prev_1_fu_161_p2 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal add_ln12_fu_144_p2 : STD_LOGIC_VECTOR (10 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln9_reg_215_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln9_reg_215 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    prev_0_reg_118_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln9_reg_215_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln9_fu_138_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then
                i_reg_224 <= i_fu_155_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_enable_reg_pp0_iter1, icmp_ln9_fu_138_p2, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if ((not(((icmp_ln9_fu_138_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) and not(((ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif ((((ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone)) or ((icmp_ln9_fu_138_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone)))) then
    ...
    accum_1_fu_178_p2 <= std_logic_vector(unsigned(mul_ln12_fu_172_p2) + unsigned(accum_0_reg_96));
    accum_fu_133_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(signed(array_load_1_reg_205) * signed(reg_128))), 32));
    add_ln12_fu_144_p2 <= std_logic_vector(unsigned(ap_phi_mux_i_0_phi_fu_110_p4) + unsigned(ap_const_lv11_7FE));
    ...
    ap_condition_pp0_exit_iter0_state5_assign_proc : process(icmp_ln9_fu_138_p2)
    begin
        if ((icmp_ln9_fu_138_p2 = ap_const_lv1_1)) then 
    ...
    ap_enable_operation_31_assign_proc : process(icmp_ln9_fu_138_p2)
    begin
                ap_enable_operation_31 <= (icmp_ln9_fu_138_p2 = ap_const_lv1_0);
    end process;


    ap_enable_operation_33_assign_proc : process(icmp_ln9_reg_215)
    begin
                ap_enable_operation_33 <= (icmp_ln9_reg_215 = ap_const_lv1_0);
    end process;


    ap_enable_operation_40_assign_proc : process(icmp_ln9_reg_215_pp0_iter1_reg)
    begin
                ap_enable_operation_40 <= (icmp_ln9_reg_215_pp0_iter1_reg = ap_const_lv1_0);
    end process;
    ...
    ap_phi_mux_i_0_phi_fu_110_p4_assign_proc : process(i_0_reg_106, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln9_reg_215, i_reg_224, ap_block_pp0_stage0)
    begin
        if (((icmp_ln9_reg_215 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    array_r_address0_assign_proc : process(ap_CS_fsm_state1, ap_CS_fsm_state2, ap_enable_reg_pp0_iter2, ap_block_pp0_stage0, zext_ln11_fu_167_p1)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            array_r_address0 <= zext_ln11_fu_167_p1(10 - 1 downto 0);
    ...
    array_r_address1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_CS_fsm_state2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0, zext_ln12_fu_150_p1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            array_r_address1 <= zext_ln12_fu_150_p1(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    array_r_ce1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, ap_CS_fsm_state2, ap_enable_reg_pp0_iter0)
    begin
    ...
    array_r_d0 <= std_logic_vector(unsigned(elem2_reg_194) + unsigned(accum_0_reg_96));

    array_r_we0_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln9_reg_215_pp0_iter1_reg, ap_enable_reg_pp0_iter2)
    begin
        if (((icmp_ln9_reg_215_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    icmp_ln9_fu_138_p2 <= "1" when (ap_phi_mux_i_0_phi_fu_110_p4 = ap_const_lv11_400) else "0";
    mul_ln12_fu_172_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(signed(reg_128) * signed(prev_0_reg_118))), 32));
    prev_1_fu_161_p2 <= std_logic_vector(unsigned(elem2_reg_194) + unsigned(accum_0_reg_96));
    zext_ln11_fu_167_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_0_reg_106_pp0_iter1_reg),64));
    zext_ln12_fu_150_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln12_fu_144_p2),64));
end behav;
